...
def main():
    ...
    # Splitting the whole dataset into training and test datasets
    train_data=whole_df.sample(frac=train_size,random_state=200)
    test_data=whole_df.drop(train_data.index).reset_index(drop=True)
